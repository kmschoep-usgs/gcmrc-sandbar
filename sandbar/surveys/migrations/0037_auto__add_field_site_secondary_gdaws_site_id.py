...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.secondary_gdaws_site_id'
        db.add_column('sites', 'secondary_gdaws_site_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.secondary_gdaws_site_id'
        db.delete_column('sites', 'secondary_gdaws_site_id')
