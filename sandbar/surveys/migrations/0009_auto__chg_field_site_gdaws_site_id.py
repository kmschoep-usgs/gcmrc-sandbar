...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Site.gdaws_site_id'
        db.alter_column('sites', 'gdaws_site_id', self.gf('django.db.models.fields.CharField')(default='', max_length=40))

    def backwards(self, orm):

        # Changing field 'Site.gdaws_site_id'
        db.alter_column('sites', 'gdaws_site_id', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))
    ...
    models = {
        u'surveys.site': {
            ...
            'gdaws_temp': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
