...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.sandbar_id'
        db.add_column('surveys', 'sandbar_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.sandbar_id'
        db.delete_column('surveys', 'sandbar_id')
    ...
    models = {
        ...
        u'surveys.survey': {
            ...
            'calc_type': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'discharge': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sandbar_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['surveys.Site']"}),
