...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AreaVolumeStg.file_name'
        db.delete_column('area_volume_calc_stage', 'file_name')


    def backwards(self, orm):
        # Adding field 'AreaVolumeStg.file_name'
        db.add_column('area_volume_calc_stage', 'file_name',
