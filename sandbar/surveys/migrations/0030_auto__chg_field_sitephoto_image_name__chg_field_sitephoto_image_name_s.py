...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SitePhoto.image_name'
        db.alter_column('site_photos', 'image_name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'SitePhoto.image_name_small'
        db.alter_column('site_photos', 'image_name_small', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'SitePhoto.image_name_med'
        db.alter_column('site_photos', 'image_name_med', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'SitePhoto.image_name'
        db.alter_column('site_photos', 'image_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'SitePhoto.image_name_small'
        db.alter_column('site_photos', 'image_name_small', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'SitePhoto.image_name_med'
        db.alter_column('site_photos', 'image_name_med', self.gf('django.db.models.fields.CharField')(max_length=30))
