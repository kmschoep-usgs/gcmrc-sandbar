...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.p_month'
        db.add_column('sites', 'p_month',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'Site.p_day'
        db.add_column('sites', 'p_day',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'Site.p_year'
        db.add_column('sites', 'p_year',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.p_month'
        db.delete_column('sites', 'p_month')

        # Deleting field 'Site.p_day'
        db.delete_column('sites', 'p_day')

        # Deleting field 'Site.p_year'
        db.delete_column('sites', 'p_year')
    ...
    models = {
        ...
        u'surveys.site': {
            ...
            'p_month': ('django.db.models.fields.CharField', [], {'max_length': '2', 'blank': 'True'}),
            'p_year': ('django.db.models.fields.CharField', [], {'max_length': '2', 'blank': 'True'}),
