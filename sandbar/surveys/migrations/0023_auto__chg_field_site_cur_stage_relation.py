...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Site.cur_stage_relation'
        db.alter_column('sites', 'cur_stage_relation', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Site.cur_stage_relation'
        db.alter_column('sites', 'cur_stage_relation', self.gf('django.db.models.fields.CharField')(max_length=100))
