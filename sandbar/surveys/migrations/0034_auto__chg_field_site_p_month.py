...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Site.p_month'
        db.alter_column('sites', 'p_month', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Site.p_month'
        db.alter_column('sites', 'p_month', self.gf('django.db.models.fields.CharField')(max_length=2))
