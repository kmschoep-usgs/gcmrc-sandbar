...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.gdaws_site_display'
        db.add_column('sites', 'gdaws_site_display',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.gdaws_site_display'
        db.delete_column('sites', 'gdaws_site_display')
