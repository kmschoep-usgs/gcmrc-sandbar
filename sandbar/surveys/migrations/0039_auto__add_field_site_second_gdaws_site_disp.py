...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.second_gdaws_site_disp'
        db.add_column('sites', 'second_gdaws_site_disp',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.second_gdaws_site_disp'
        db.delete_column('sites', 'second_gdaws_site_disp')
