...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AreaVolume.prev_plane_height'
        db.add_column('area_volume_calc', 'prev_plane_height',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=9),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AreaVolume.prev_plane_height'
        db.delete_column('area_volume_calc', 'prev_plane_height')
