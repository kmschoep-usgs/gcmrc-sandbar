...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sandbar'
        db.create_table('site_sandbar_rel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surveys.Site'])),
            ('sandbar_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'surveys', ['Sandbar'])

        # Adding unique constraint on 'Sandbar', fields ['site', 'sandbar_name']
        db.create_unique('site_sandbar_rel', ['site_id', 'sandbar_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Sandbar', fields ['site', 'sandbar_name']
        db.delete_unique('site_sandbar_rel', ['site_id', 'sandbar_name'])

        # Deleting model 'Sandbar'
        db.delete_table('site_sandbar_rel')
