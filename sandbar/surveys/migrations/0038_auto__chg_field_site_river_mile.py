...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Site.river_mile'
        db.alter_column('sites', 'river_mile', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Site.river_mile'
        db.alter_column('sites', 'river_mile', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))
