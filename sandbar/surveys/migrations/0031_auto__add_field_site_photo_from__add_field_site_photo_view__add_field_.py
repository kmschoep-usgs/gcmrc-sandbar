...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.photo_from'
        db.add_column('sites', 'photo_from',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Site.photo_view'
        db.add_column('sites', 'photo_view',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Site.flow_direction'
        db.add_column('sites', 'flow_direction',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Site.image_name'
        db.add_column('sites', 'image_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Site.image_name_med'
        db.add_column('sites', 'image_name_med',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Site.image_name_small'
        db.add_column('sites', 'image_name_small',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.photo_from'
        db.delete_column('sites', 'photo_from')

        # Deleting field 'Site.photo_view'
        db.delete_column('sites', 'photo_view')

        # Deleting field 'Site.flow_direction'
        db.delete_column('sites', 'flow_direction')

        # Deleting field 'Site.image_name'
        db.delete_column('sites', 'image_name')

        # Deleting field 'Site.image_name_med'
        db.delete_column('sites', 'image_name_med')

        # Deleting field 'Site.image_name_small'
        db.delete_column('sites', 'image_name_small')
    ...
    models = {
        ...
        u'surveys.sitephoto': {
            ...
            'image_name_med': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'image_name_small': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
