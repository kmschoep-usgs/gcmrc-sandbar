...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Site.stage_discharge_coeff_b'
        db.alter_column('sites', 'stage_discharge_coeff_b', self.gf('django.db.models.fields.DecimalField')(default=2, max_digits=15, decimal_places=13))

        # Changing field 'Site.stage_discharge_coeff_a'
        db.alter_column('sites', 'stage_discharge_coeff_a', self.gf('django.db.models.fields.DecimalField')(default=2, max_digits=16, decimal_places=13))

        # Changing field 'Site.stage_discharge_coeff_c'
        db.alter_column('sites', 'stage_discharge_coeff_c', self.gf('django.db.models.fields.DecimalField')(default=2, max_digits=18, decimal_places=15))

    def backwards(self, orm):

        # Changing field 'Site.stage_discharge_coeff_b'
        db.alter_column('sites', 'stage_discharge_coeff_b', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=13))

        # Changing field 'Site.stage_discharge_coeff_a'
        db.alter_column('sites', 'stage_discharge_coeff_a', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=16, decimal_places=13))

        # Changing field 'Site.stage_discharge_coeff_c'
        db.alter_column('sites', 'stage_discharge_coeff_c', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=15))
